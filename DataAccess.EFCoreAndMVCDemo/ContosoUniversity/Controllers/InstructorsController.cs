    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id,int? courseID)
        {
            ...
            if (id != null)
            {
                ...
                Instructor instructor = viewModel.Instructors.Where(w => w.ID == id.Value).Single();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var departments = await _context.Departments
                .Where(w => w.InstructorID == id)
                .ToListAsync();
            departments.ForEach(f => f.InstructorID = null);
        ...
        private void UpdateInstructorCourses(string[] selectedCourses,Instructor instructorToUpdate)
        {
            ...
            var instructorCourses = new HashSet<int>(instructorToUpdate.CourseAssignments.Select(s => s.Course.CourseID));
